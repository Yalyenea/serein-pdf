> **Archive** · 2026-08-05  
> Snapshot of completed milestone checklists and UAT history moved out of live [TASKS.md](../../TASKS.md).  
> Authority for shipped behavior: git history + [CHANGELOG.md](../../CHANGELOG.md). Do not treat this file as an active backlog.
