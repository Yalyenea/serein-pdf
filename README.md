...
- Spotlight-style recent-files launcher (`cmd+shift+space`) stays compact, hides traffic lights, supports system IME input, title/path filtering, `space` multi-select, `enter` open, and `?` inline help
